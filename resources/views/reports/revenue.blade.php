...
@section('judul', 'Revenue Packages')
@section('showerrepot', 'show')
@section('boldrev', 'font-weight-bolder')
@section('content')
...
<link rel="stylesheet" href="{{ asset('manual/morris/morrisjs/morris.css') }}" />
                ...
                <div class="col-sm-9" title="content" style="margin-left:25px;font-size: 90%">
                    <h4>Revenue Packages</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/home"><i class="fas fa-home fa-sm"></i></a></li>
                        <li class="breadcrumb-item active" aria-current="page">Revenue Packages</li>
                    </ol>
                    <!-- Kartu dashboard -->
                    <div class="card">
                        <div class="card-body">
                            <form action="#/action_page.php">
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" placeholder="Nama Packages...or blank for all data" name="search">

...
@section('judul', 'Report Packages')
@section('showerrepot', 'show')
@section('boldpac', 'font-weight-bolder')
@section('content')
...
<link rel="stylesheet" href="{{ asset('manual/morris/morrisjs/morris.css') }}" />
                ...
                <div class="col-sm-9" title="content" style="margin-left:25px;font-size: 90%">
                    <h4>Report Packages</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/home"><i class="fas fa-home fa-sm"></i></a></li>
                        <li class="breadcrumb-item active" aria-current="page">Report Packages</li>
                    </ol>
                    <!-- Kartu dashboard -->
                    <div class="card">
                        <div class="card-body">
